...
namespace Luvina\Test\Ui\DataProvider;

use Luvina\Test\Api\Data\BooksInterface;
use Luvina\Test\Query\Books\GetListQuery;
 ...
 */
class BooksDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item[BooksInterface::BOOKS_ID]] = $item;
        }

        if ($id = $this->request->getParam(BooksInterface::BOOKS_ID)) {

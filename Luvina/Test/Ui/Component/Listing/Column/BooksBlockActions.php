 ...
 */
class BooksBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Books';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'books/books/edit';
    private const DELETE_URL_PATH = 'books/books/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[BooksInterface::BOOKS_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [BooksInterface::BOOKS_ID => $item[BooksInterface::BOOKS_ID]];
